...
class BookModel extends AbstractModel 
{
    ...
    // getAll(1, 3): sending an array of books from page number 1, and showing 3 books per page.
...
SQL;
    ...
    // getCopy() need to be called before calling this method
...
SQL;
        ...
        // // addCopy() need to be called before calling this method
        $this->updateBookStock($book);
    }
